"""Populates a configuration file for jolly-brancher. Entries can be incomplete."""

import os
import configparser

KEYS_AND_PROMPTS = [['email', 'your login email for Atlassian'], ['base_url', 'the base URL for Atlassian (e.g., https://cirrusv2x.atlassian.net)'], ['token', 'your Atlassian API token which can be generated here (https://id.atlassian.com/manage-profile/security/api-tokens)'], ['repo_root', 'the path to the root directory for the repository']]
